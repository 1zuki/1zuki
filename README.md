...
I like understanding how things work under the hood, then turning messy ideas into clean working systems.


### Tech

`Python` · `C++` · `PyTorch` · `NumPy` · `pandas` · `Polars` · `Transformers` · `FAISS` · `Linux` · `LaTeX`

</td>
<td width="42%" align="center">

<img src="./assets/witch.png" width="320" alt="Profile image"/>
